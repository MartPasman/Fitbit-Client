...
function loadUsers(users) {
    ...
    for (let i = 0; i < users.length; i++) {
        ...
        if (user.active && user.fitbit !== undefined && user.fitbit !== null) {
            html += "<span data-toggle='tooltip' data-placement='top' data-container='body' title='Deze gebruiker is gekoppeld aan Fitbit " + user.fitbit.userid + "' class='col-xs-1 glyphicon glyphicon-link is-connected'></span>";
        }
